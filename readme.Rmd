...
* <strong>Full Text API</strong>
	*   `get_data_ft_v2_api()` - retrieves descriptive data from V2 API see [this](http://asbcllc.com/blog/2017/august/intro_to_programming_with_gdeltr2/index.html) blog post for more on how to use this
...
You can refer to [this](http://asbcllc.com/blog/2017/august/intro_to_programming_with_gdeltr2/index.html) blog post that discusses how to use this functionality.
